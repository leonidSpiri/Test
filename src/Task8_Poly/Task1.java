...
public class Task1 {
    public static void main(String[] args) {
                            ...
                            for (int i6 = 0; i6 < 7; i6++) {
                                ...
                                for (int i7 = 0; i7 < 7; i7++) {
                                    if (!(i7 == i1 || i7 == i2 || i7 == i3 || i7 == i4 || i7 == i5 || i7 == i6)) {
                                        ...
                                        boolean istrue = true;
                                        if (buff.charAt(6) == 'Ь') istrue = false;
                                        for (int i = 1; i < buff.length() - 1; i++) {
                                            if (buff.charAt(i) == 'Ь' && (buff.charAt(i - 1) == 'Е' || buff.charAt(i - 1) == 'И')
                                                    && (buff.charAt(i + 1) == 'Е' || buff.charAt(i + 1) == 'И'))
                                                istrue = false;
                                        }
                                        if (istrue) result++;
                                    }
        ...
        System.out.println(result); //4080
    }
}
